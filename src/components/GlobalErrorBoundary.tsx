...
class ErrorBoundaryInner extends Component<InnerProps, InnerState> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-[var(--color-charcoal,#1A1A2E)] flex items-center justify-center p-4">
          <div className="glass-elevated rounded-2xl border border-white/[0.15] p-8 max-w-md w-full text-center">
            ...
            <div className="flex items-center justify-center gap-3 flex-wrap">
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-sm bg-white/[0.08] border border-white/[0.15] text-kalkvit hover:bg-white/[0.12] transition-all duration-200 cursor-pointer"
              >
                <RefreshCw size={16} />
                Try Again
              </button>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-sm bg-gradient-to-br from-koppar to-[#A66529] text-kalkvit shadow-[0_4px_20px_rgba(184,115,51,0.4)] hover:shadow-[0_6px_24px_rgba(184,115,51,0.5)] hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
              >
                <Bug size={16} />
                Report Bug
              </button>
